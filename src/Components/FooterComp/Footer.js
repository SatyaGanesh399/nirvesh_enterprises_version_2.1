...
const listData = [
    'About us', 'Milestones', 'Terms of service', 'privacy policy'
]
const listItems = ({item}) => {
    return (
        <div className='item-container'>
            <BsFillCaretRightFill size={12} color={colors.navy} />
  ...
  return (
    <div className='footer'>
        <div className="newsletter">
            ...
            <p className='newsletter-subheading'>Please subscribe to newsletter to know more about our research...</p>
        ...
        <div className='footer-menu'>
            ...
            <p className='footer-heading'>Our Social Networks</p>
                <div>
                    <BsTwitter size={30} color={colors.primaryWhite} className="social-media-icon" />
                    <BsFacebook size={30} color={colors.primaryWhite}
                    className="social-media-icon"  />
                    <AiFillInstagram size={30} color={colors.primaryWhite} 
                    className="social-media-icon" />
                    <BsSkype size={30} color={colors.primaryWhite}
                    className="social-media-icon"  />
                    <BsLinkedin size={30} color={colors.primaryWhite}  
                    className="social-media-icon"/>
                </div>
            </div>
            <div className='playstore-comp'>
                ...
                <div>
                    ...
                    <p className='playstore-message'>Scan the QR to download our Synapsil App</p>
                    <p className='playstore-message'>Recommanded only for patients</p>
                    <u className='playstore-message click-here'>click here to rate our app in the play store</u>
                </div>
